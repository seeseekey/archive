...
type
  TFormReplaceConfirm = class(TForm)
    btnReplace: TButton;
...
var
  FormReplaceConfirm: TFormReplaceConfirm;
...
resourcestring
  SAskReplaceText = 'Dieses Vorkommen von "%s" ersetzen?';

{ TConfirmReplaceDialog }

procedure TFormReplaceConfirm.FormCreate(Sender: TObject);
begin
  Image1.Picture.Icon.Handle := LoadIcon(0, IDI_QUESTION);
end;

procedure TFormReplaceConfirm.FormDestroy(Sender: TObject);
begin
  FormReplaceConfirm := nil;
end;

procedure TFormReplaceConfirm.PrepareShow(AEditorRect: TRect;
