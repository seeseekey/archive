...
uses
  ...
  StdCtrls, ExtCtrls, TntStdCtrls, uFormSearch;

type
  TFormReplace = class(TFormSearch)
    Label2: TLabel;
...
function TFormReplace.GetReplaceText: string;
begin
  Result := cbReplaceText.Text;
end;

function TFormReplace.GetReplaceTextHistory: string;
var
  i: integer;
begin
  Result := '';
...
procedure TFormReplace.SetReplaceText(Value: string);
begin
  cbReplaceText.Text := Value;
end;

procedure TFormReplace.SetReplaceTextHistory(Value: string);
begin
  cbReplaceText.Items.Text := Value;
end;

procedure TFormReplace.FormCloseQuery(Sender: TObject;
