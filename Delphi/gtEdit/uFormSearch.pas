...
function TFormSearch.GetSearchBackwards: boolean;
begin
  Result := rgSearchDirection.ItemIndex = 1;
end;

function TFormSearch.GetSearchCaseSensitive: boolean;
begin
  Result := cbSearchCaseSensitive.Checked;
end;

function TFormSearch.GetSearchFromCursor: boolean;
begin
  Result := cbSearchFromCursor.Checked;
end;

function TFormSearch.GetSearchInSelection: boolean;
begin
  Result := cbSearchSelectedOnly.Checked;
end;

function TFormSearch.GetSearchRegularExpression: boolean;
begin
  Result := cbRegularExpression.Checked;
end;

function TFormSearch.GetSearchText: string;
begin
  Result := cbSearchText.Text;
end;

function TFormSearch.GetSearchTextHistory: string;
var
  i: integer;
begin
  Result := '';
...
function TFormSearch.GetSearchWholeWords: boolean;
begin
  Result := cbSearchWholeWords.Checked;
end;

procedure TFormSearch.SetSearchBackwards(Value: boolean);
begin
  rgSearchDirection.ItemIndex := Ord(Value);
end;

procedure TFormSearch.SetSearchCaseSensitive(Value: boolean);
begin
  cbSearchCaseSensitive.Checked := Value;
end;

procedure TFormSearch.SetSearchFromCursor(Value: boolean);
begin
  cbSearchFromCursor.Checked := Value;
end;

procedure TFormSearch.SetSearchInSelection(Value: boolean);
begin
  cbSearchSelectedOnly.Checked := Value;
end;

procedure TFormSearch.SetSearchText(Value: string);
begin
  cbSearchText.Text := Value;
end;

procedure TFormSearch.SetSearchTextHistory(Value: string);
begin
  cbSearchText.Items.Text := Value;
end;

procedure TFormSearch.SetSearchWholeWords(Value: boolean);
begin
  cbSearchWholeWords.Checked := Value;
end;

procedure TFormSearch.SetSearchRegularExpression(
  const Value: boolean);
begin
...
procedure TFormSearch.FormCloseQuery(Sender: TObject;
