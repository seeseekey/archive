...
var
  FormPrintPreview: TFormPrintPreview;

implementation

{$R *.DFM}

procedure TFormPrintPreview.FormShow(Sender: TObject);
begin
  SynEditPrintPreview.UpdatePreview;
  SynEditPrintPreview.FirstPage;
  if Printer.PrinterIndex >= 0 then
    PrintCmd.Hint := 'Drucke (' + Printer.Printers[Printer.PrinterIndex] +
      ')|Drucke Dokument auf ' + Printer.Printers[Printer.PrinterIndex];
end;

procedure TFormPrintPreview.FirstCmdExecute(Sender: TObject);
begin
  SynEditPrintPreview.FirstPage;
end;

procedure TFormPrintPreview.PrevCmdExecute(Sender: TObject);
begin
  SynEditPrintPreview.PreviousPage;
end;

procedure TFormPrintPreview.NextCmdExecute(Sender: TObject);
begin
  SynEditPrintPreview.NextPage;
end;

procedure TFormPrintPreview.LastCmdExecute(Sender: TObject);
begin
  SynEditPrintPreview.LastPage;
end;

procedure TFormPrintPreview.ZoomCmdExecute(Sender: TObject);
begin
  SynEditPrintPreview.ScaleMode := pscWholePage;
end;

procedure TFormPrintPreview.PrintCmdExecute(Sender: TObject);
begin
  SynEditPrintPreview.Print;
end;

procedure TFormPrintPreview.CloseCmdExecute(Sender: TObject);
begin
  Close;
end;

procedure TFormPrintPreview.Fitto1Click(Sender: TObject);
begin
...
procedure TFormPrintPreview.ApplicationEvents1Hint(Sender: TObject);
begin
  StatusBar.Panels[0].Text := '  ' + Application.Hint;
end;

procedure TFormPrintPreview.SynEditPrintPreviewMouseDown(
...
procedure TFormPrintPreview.SynEditPrintPreviewPreviewPage(
