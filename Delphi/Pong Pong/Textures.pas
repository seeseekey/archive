...
{  Load JPEG textures                                              }
{------------------------------------------------------------------}
function LoadJPGTexture(Filename: String; var Texture: TGLuint; LoadFromResource : Boolean): Boolean;
var
...
{------------------------------------------------------------------}
function LoadTGATexture(Filename: String; var Texture: TGLuint; LoadFromResource : Boolean): Boolean;
var
