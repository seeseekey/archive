...
begin
 Result:='none';
 if mode = 1 then Result:='Standard AI' // AI Name
 else if mode = 2 then Result:='1.00.06' // AI Version
 else if mode = 3 then Result:='Global Technology' // AI Autor
 else if mode = 4 then Result:='Einsteiger' // AI Level - Sehr leicht, Leicht, Medium, Schwer, Extrem Schwer, Unbesiegbar
 ...
 else if mode = 8 then Result:='GTSI' // AI ID wird zum korekten Laden der AI aus Spielständen benötigt
 else if mode = 9 then Result:='standard.ini'; // Name der AI Ini Datei zur speicherung von Bewertungen etc.
end;
