...
namespace AODL.Document.Forms.Controls
{
	...
	public class ODFFormattedText: ODFTextArea
	{
		...
		public ODFFormattedText(ODFForm ParentForm, IContentCollection contentCollection, string id): base (ParentForm, contentCollection, id)
		{}
		...
		public ODFFormattedText(ODFForm ParentForm, IContentCollection contentCollection, string id, string x, string y, string width, string height): base (ParentForm, contentCollection, id, x, y, width, height)
		{}

		internal ODFFormattedText(ODFForm ParentForm, XmlNode node): base(ParentForm, node)
		{}
