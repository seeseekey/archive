...
namespace AODL.Document.Forms.Controls
{
	...
	public class ODFTime: ODFFormControl
	{
		...
		public ODFTime(ODFForm ParentForm, IContentCollection contentCollection, string id): base (ParentForm, contentCollection, id)
		{}
		...
		public ODFTime(ODFForm ParentForm, IContentCollection contentCollection, string id, string x, string y, string width, string height): base (ParentForm, contentCollection, id, x, y, width, height)
		{}

		internal ODFTime(ODFForm ParentForm, XmlNode node): base(ParentForm, node)
		{}
