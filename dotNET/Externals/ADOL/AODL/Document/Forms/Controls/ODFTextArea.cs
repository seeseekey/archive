...
namespace AODL.Document.Forms.Controls
{
	public class ODFTextArea: ODFFormControl
	{
		...
		public ODFTextArea(ODFForm ParentForm, IContentCollection contentCollection, string id): base (ParentForm, contentCollection, id)
		{}
		...
		public ODFTextArea(ODFForm ParentForm, IContentCollection contentCollection, string id, string x, string y, string width, string height): base (ParentForm, contentCollection, id, x, y, width, height)
		{}

		internal ODFTextArea(ODFForm ParentForm, XmlNode node): base(ParentForm, node)
		{}
