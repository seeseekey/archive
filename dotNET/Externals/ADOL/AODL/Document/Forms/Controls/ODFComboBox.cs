...
namespace AODL.Document.Forms.Controls
{
	public class ODFComboBox: ODFFormControl
	{
		...
		internal void SuppressItemEvents()
		{
			_items.Inserted -=new ODFItemCollection.CollectionChange(ItemCollection_Inserted);
			_items.Removed -=new ODFItemCollection.CollectionChange(ItemCollection_Removed);
		}

		internal void RestoreItemEvents()
		{
			_items.Inserted +=new ODFItemCollection.CollectionChange(ItemCollection_Inserted);
			_items.Removed +=new ODFItemCollection.CollectionChange(ItemCollection_Removed);
		}
		...
		internal void FixItemCollection()
		{
			_items.Clear();
			SuppressItemEvents();
		...
		public ODFComboBox(ODFForm ParentForm, IContentCollection contentCollection, string id): base (ParentForm, contentCollection, id)
		{
		...
		public ODFComboBox(ODFForm ParentForm, IContentCollection contentCollection, string id, string x, string y, string width, string height): base (ParentForm, contentCollection, id, x, y, width, height)
		{
			_items = new ODFItemCollection();
			RestoreItemEvents();
		}
		...
		internal ODFComboBox(ODFForm ParentForm, XmlNode node): base(ParentForm, node)
		{
			_items = new ODFItemCollection();
			RestoreItemEvents();
		}
