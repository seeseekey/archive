...
namespace AODL.Document.Forms.Controls
{
	...
	public class ODFNumber: ODFFormControl
	{
		...
		public ODFNumber(ODFForm ParentForm, IContentCollection contentCollection, string id): base (ParentForm, contentCollection, id)
		{}
		...
		public ODFNumber(ODFForm ParentForm, IContentCollection contentCollection, string id, string x, string y, string width, string height): base (ParentForm, contentCollection, id, x, y, width, height)
		{}

		internal ODFNumber(ODFForm ParentForm, XmlNode node): base(ParentForm, node)
		{}
