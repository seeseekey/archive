...
namespace AODL.Document.Forms.Controls
{
	public class ODFRadioButton: ODFFormControl
	{
		...
		public ODFRadioButton(ODFForm ParentForm, IContentCollection contentCollection, string id): base (ParentForm, contentCollection, id)
		{}
		...
		public ODFRadioButton(ODFForm ParentForm, IContentCollection contentCollection, string id, string x, string y, string width, string height): base (ParentForm, contentCollection, id, x, y, width, height)
		{}

		internal ODFRadioButton(ODFForm ParentForm, XmlNode node): base(ParentForm, node)
		{}
