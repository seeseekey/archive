 ...
 *
 * $RCSfile: ParagraphCollection.cs,v $
 *
 * $Revision: 1.2 $
 *
...
namespace AODL.Document.Content.Text
{
	...
	public class ParagraphCollection : CollectionWithEvents
	{
		...
		/// </summary>
		/// <value></value>
		public AODL.Document.Content.Text.Paragraph this[int index]
		{
			get { return (base.List[index] as AODL.Document.Content.Text.Paragraph); }
		}
	}
}
