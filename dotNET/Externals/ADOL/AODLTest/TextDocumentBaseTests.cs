 ...
 *
 * $RCSfile: TextDocumentBaseTests.cs,v $
 *
 * $Revision: 1.5 $
 *
...
namespace AODLTest
{
	...
	public class TextDocumentBaseTests
	{
		...
		public void TestCloning()
		{
			...
			Assert.AreSame(paragraph.Node, paragraphClone.Node, "Should be cloned and not equal.");
			...
			Assert.AreSame(paragraphClone2.Node, paragraphClone.Node, "Should be cloned and not equal.");
