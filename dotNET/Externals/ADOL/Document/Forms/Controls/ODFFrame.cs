...
namespace AODL.Document.Forms.Controls
{
	...
	public class ODFFrame: ODFFormControl
	{
		...
		public ODFFrame(ODFForm ParentForm, IContentCollection contentCollection, string id): base (ParentForm, contentCollection, id)
		{}
		...
		public ODFFrame(ODFForm ParentForm, IContentCollection contentCollection, string id, string x, string y, string width, string height): base (ParentForm, contentCollection, id, x, y, width, height)
		{}

		internal ODFFrame(ODFForm ParentForm, XmlNode node): base(ParentForm, node)
		{}
