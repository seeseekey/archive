...
namespace AODL.Document.Forms.Controls
{
	public class ODFValueRange: ODFFormControl
	{
		...
		public ODFValueRange(ODFForm ParentForm, IContentCollection contentCollection, string id): base (ParentForm, contentCollection, id)
		{}
		...
		public ODFValueRange(ODFForm ParentForm, IContentCollection contentCollection, string id, string x, string y, string width, string height): base (ParentForm, contentCollection, id, x, y, width, height)
		{}

		internal ODFValueRange(ODFForm ParentForm, XmlNode node): base(ParentForm, node)
		{}
