...
namespace AODL.Document.Forms.Controls
{
	public class ODFCheckBox: ODFFormControl
	{
		...
		public ODFCheckBox(ODFForm ParentForm, IContentCollection contentCollection, string id): base (ParentForm, contentCollection, id)
		{}
		...
		public ODFCheckBox(ODFForm ParentForm, IContentCollection contentCollection, string id, string x, string y, string width, string height): base (ParentForm, contentCollection, id, x, y, width, height)
		{}

		internal ODFCheckBox(ODFForm ParentForm, XmlNode node): base(ParentForm, node)
		{}
