 ...
 *
 * $RCSfile: ODFOptionCollection.cs,v $
 *
 * $Revision: 1.3 $
 *
...
namespace AODL.Document.Forms.Controls
{
	...
	/// </summary>
	public class ODFOptionCollection : CollectionWithEvents
	{
		/// <summary>
		...
		/// <returns></returns>
		public int Add(ODFOption value)
		{
		...
		/// </summary>
		/// <param name="value">The option.</param>
		public void Remove(ODFOption value)
		{
		...
		/// <param name="value">The option.</param>
		public void Insert(int index, ODFOption value)
		{
		...
		/// </summary>
		/// <param name="value">The option.</param>
		public bool Contains(ODFOption value)
		{
		...
		/// </summary>
		/// <value>Index</value>
		public ODFOption this[int index]
		{
			get { return (base.List[index] as ODFOption); }
		}
	}
}
