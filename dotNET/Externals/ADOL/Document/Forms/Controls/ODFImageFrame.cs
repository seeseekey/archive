...
namespace AODL.Document.Forms.Controls
{
	public class ODFImageFrame: ODFFormControl
	{
		...
		public ODFImageFrame(ODFForm ParentForm, IContentCollection contentCollection, string id): base (ParentForm, contentCollection, id)
		{}
		...
		public ODFImageFrame(ODFForm ParentForm, IContentCollection contentCollection, string id, string x, string y, string width, string height): base (ParentForm, contentCollection, id, x, y, width, height)
		{}

		internal ODFImageFrame(ODFForm ParentForm, XmlNode node): base(ParentForm, node)
		{}
