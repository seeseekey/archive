	...
	public class ODFForm
	{
		...
		{	
			get
			{
				...
				switch (s)
				{
					case "get": mt = Method.Get; break;
					case "post": mt = Method.Post; break;
					default: mt = Method.NotSet; break;
				}
				return mt;
			}
			set
		...
		{	
			...
			set
			{
				...
				switch (value)
				{
					case NavigationMode.Current: s = "current"; break;
					case NavigationMode.Parent: s = "parent"; break;
					case NavigationMode.None: s = "none"; break;
					default: return; break;
				}
		...
		public ODFForm(IDocument document, string name)
		{
			...
			_controls.Inserted +=new ODFControlsCollection.CollectionChange(ControlsCollection_Inserted);
			_controls.Removed +=new ODFControlsCollection.CollectionChange(ControlsCollection_Removed);
			_controls.Clearing +=new ODFControlsCollection.CollectionClear(ControlsCollection_Clearing);
			...
			_formCollection.Inserted +=new ODFFormCollection.CollectionChange(FormCollection_Inserted);
			_formCollection.Removed +=new ODFFormCollection.CollectionChange(FormCollection_Removed);
			
		}

		internal ODFForm(XmlNode node, IDocument document)
		{
			Document = document;
			this.Node = node;
		...
		internal void SuppressControlEvents()
		{
			_controls.Inserted -=new ODFControlsCollection.CollectionChange(ControlsCollection_Inserted);
			_controls.Removed -=new ODFControlsCollection.CollectionChange(ControlsCollection_Removed);
			_controls.Clearing -=new ODFControlsCollection.CollectionClear(ControlsCollection_Clearing);
		...
		internal void RestoreControlEvents()
		{
			_controls.Inserted +=new ODFControlsCollection.CollectionChange(ControlsCollection_Inserted);
			_controls.Removed +=new ODFControlsCollection.CollectionChange(ControlsCollection_Removed);
			_controls.Clearing +=new ODFControlsCollection.CollectionClear(ControlsCollection_Clearing);
