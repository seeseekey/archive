 ...
 *
 * $RCSfile: TextDocumentHelper.cs,v $
 *
 * $Revision: 1.6 $
 *
...
namespace AODL.Document.TextDocuments
{
	...
	public class TextDocumentHelper
	{
		...
		public static XmlNamespaceManager NameSpace(XmlNameTable nametable)
		{
			...
			xmlnsManager.AddNamespace ("manifest",  "urn:oasis:names:tc:opendocument:xmlns:manifest:1.0");
			xmlnsManager.AddNamespace ("chart",     "urn:oasis:names:tc:opendocument:xmlns:chart:1.0");
 ...
 * Revision 1.6  2008/04/29 15:39:57  mt
 * new copyright header
 *
 * Revision 1.5  2008/02/08 07:12:21  larsbehr
