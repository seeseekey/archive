...
namespace AODL.Document.TextDocuments
{
	...
	public class TextDocument : IDisposable, IDocument //AODL.Document.TextDocuments.Content.IContentContainer,
	{
		...
		public TextDocument()
		{
			...
			this._formCollection.Removed += new AODL.Document.Collections.CollectionWithEvents.CollectionChange(FormsCollection_Removed);
		...
		public void New()
		{
			...
			MasterPageFactory.FillFromXMLDocument(this);
		}
